...
export class NoteQuestionParser {
    ...
    private doCreateQuestionList(
        ...
        for (const parsedQuestionInfo of parsedQuestionInfoList) {
            ...
            // Section-based cards store scheduling at end of note, not inline
            if (question.questionType === CardType.SectionBased) {
                cardScheduleInfoList = NoteCardScheduleParser.createCardScheduleInfoListFromNoteText(noteText);
            } else {
                cardScheduleInfoList = NoteCardScheduleParser.createCardScheduleInfoList(question.questionText.original);
            }
    ...
    private parseQuestions(): ParsedQuestionInfo[] {
        ...
        const parserOptions: ParserOptions = {
            ...
            enableSectionBasedCards: settings.enableSectionBasedCards,
            sectionFrontHeading: settings.sectionFrontHeading,
            sectionBackHeading: settings.sectionBackHeading,
        };
